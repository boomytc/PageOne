...
function Install_Detect()
{
    ...
    if (_ReportOK.Register == undefined) //if ((_ReportOK == null) || (_ReportOK.Register == undefined))
    {
        ...
        document.write('<a href="' + gr_InstallPath + '/grbsctl6.exe"><strong>点击此处下载锐浪报表插件安装包<br /></strong></a>');
        document.write('锐浪报表插件安装后，<a href="#" onclick="javascript:document.location.reload();">点击此处</a> 重新加载此页面。如果这些提示文字还出现，可能是当前浏览器不支持插件，<a href="http://www.rubylong.cn/grplugin_browsersupport.htm">点击了解更多说明</a>。');
        document.write('</div>');
        return false;
    }
